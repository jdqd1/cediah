-- Dynamic content studio for guides, videos, quizzes, flashcards and topics.
-- Browser roles keep no direct table access; Fastify remains the authorization boundary.

alter type public.platform_role
add value if not exists 'community_contributor' after 'student';
...
create table public.content_items (
  ...
  constraint content_items_version_positive check (
    version > 0
  ),

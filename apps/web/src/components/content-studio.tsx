...
function TypeEditor({
  ...
  if (draft.kind === "video") {
    return (
      <section className="studio-type-editor studio-guide-launch" aria-labelledby="video-guide-launch-title">
        <span className="studio-guide-launch-icon"><Notebook size={24} /></span>
        <div>
          <h4 id="video-guide-launch-title">Guía y recursos de aprendizaje</h4>
          <p>
            Formatea la guía, agrega puntos clave y construye el cuestionario en un espacio dedicado.
          </p>
          <small>
        ...
        <button className="studio-button studio-button-secondary" type="button" onClick={onOpenGuide}>
          Abrir editor de guía <CaretRight size={16} />
        </button>
      </section>
    );
  }
  ...
  if (draft.kind === "guide") {
    return (
      <section className="studio-type-editor studio-guide-launch" aria-labelledby="guide-launch-title">
        <span className="studio-guide-launch-icon"><Notebook size={24} /></span>
        <div>
          <h4 id="guide-launch-title">Contenido de la guía</h4>
          <p>El contenido y sus secciones se administran desde el editor visual.</p>
        </div>
        <button className="studio-button studio-button-secondary" type="button" onClick={onOpenGuide}>
          Abrir editor de guía <CaretRight size={16} />
        </button>

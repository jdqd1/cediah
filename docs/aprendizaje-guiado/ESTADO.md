...
- Vercel desplegó el flujo de omisión en `c303227` y la compatibilidad final del reproductor en `d162ff8` (`dpl_Dj8Tf3NszGZevzcUZ7rPtQpBoAxk`, verificado en estado `READY`). La compatibilidad de API se incorporó en `38b6a9f` (`dep-dafnh03bc2fs73df97g0`) y permanece incluida en los despliegues automáticos posteriores de `main`.
